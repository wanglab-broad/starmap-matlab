...
input_path = 'Z:/Data/Processed/2021-11-23-Hu-MouseBrainRIBOmap-test/';
...
sdata = sdata.MorphoRecon('Method', "2d", 'radius', MR_radius);
...
sdata = sdata.ReadsExtraction('voxelSize', RE_voxelSize);
